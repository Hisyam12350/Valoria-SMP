...
import { Shield, Eye, EyeOff, CheckCircle, AlertTriangle, Loader2, Lock } from 'lucide-react';
            ...
            <AnimatePresence>
              {success && (
                ...
                >
                  ...
                  <p className="text-emerald-400 font-semibold text-lg">Superadmin Berhasil Dibuat!</p>
            ...
            {!success && (
              <div className="space-y-4">
                ...
                >
                  ...
                  <p>
                    Halaman ini hanya bisa dipakai <strong>sekali</strong>. Setelah superadmin dibuat,
                    halaman ini otomatis tidak bisa diakses lagi.
                  </p>
                </div>
                ...
                <div>
                  <label className="block text-xs text-gray-400 mb-1.5 uppercase tracking-wider">
                    Password <span className="text-gray-500">(min. 12 karakter)</span>
                  </label>
                ...
                <div>
                  ...
                  />
                  {form.confirmPassword && form.password !== form.confirmPassword && (
                    <p className="text-red-400 text-xs mt-1">Password tidak sama</p>
                  )}
                </div>
