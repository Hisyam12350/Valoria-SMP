...
import { Shield, Eye, EyeOff, AlertTriangle, Lock, User, Loader2 } from 'lucide-react';
...
const CF_SITE_KEY = process.env.NEXT_PUBLIC_CF_TURNSTILE_SITE_KEY || '0x4AAAAAADBQccjz_Dzel_jp'; // dev test key
...
export default function AdminLoginPage() {
  ...
  useEffect(() => {
    ...
    window.onTurnstileLoaded = () => setCaptchaReady(true);
  ...
  useEffect(() => {
    if (!captchaReady || !captchaRef.current || !window.turnstile) return;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4"
      style={{
        background: 'linear-gradient(135deg, #0a0a1a 0%, #0d1117 50%, #060d1f 100%)',
      }}
    >
      ...
      {/* Glow */}
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full opacity-10 blur-[120px]"
      ...
      >
        ...
        >
          ...
          <div className="h-1 w-full"
            style={{ background: 'linear-gradient(90deg, #10b981, #059669, #34d399, #10b981)', backgroundSize: '200%' }}
          />
          ...
          <div className="p-8">
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-white font-minecraft text-center" style={{ fontSize: '1.1rem' }}>
